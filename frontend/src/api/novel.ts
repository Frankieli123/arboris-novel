...
export class NovelAPI {
  ...
  static async converseConcept(
    ...
    return request(`${API_BASE_URL}${API_PREFIX}/tasks/concept-converse`, {
      method: 'POST',
      body: JSON.stringify({
  ...
  static async generateBlueprint(projectId: string): Promise<{ task_id: string; status: string; created_at: string }> {
    return request(`${API_BASE_URL}${API_PREFIX}/tasks/blueprint-generate`, {
      method: 'POST',
      body: JSON.stringify({
        project_id: projectId
      })
  ...
  static async generateChapter(projectId: string, chapterNumber: number, writingNotes?: string): Promise<{ task_id: string; status: string; created_at: string }> {
    return request(`${API_BASE_URL}${API_PREFIX}/tasks/chapter-generate`, {
      method: 'POST',
      body: JSON.stringify({ 
        project_id: projectId,
  ...
  static async evaluateChapter(projectId: string, chapterNumber: number): Promise<{ task_id: string; status: string; created_at: string }> {
    return request(`${API_BASE_URL}${API_PREFIX}/tasks/chapter-evaluate`, {
      method: 'POST',
      body: JSON.stringify({ 
        project_id: projectId,
        chapter_number: chapterNumber
  ...
  static async generateChapterOutline(
    ...
    return request(`${API_BASE_URL}${API_PREFIX}/tasks/outline-generate`, {
      method: 'POST',
      body: JSON.stringify({
        project_id: projectId,
