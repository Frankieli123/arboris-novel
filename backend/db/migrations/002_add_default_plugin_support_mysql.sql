-- Migration: Add Default Plugin Support (MySQL)
-- Date: 2024-01-XX
...
-- Step 4: Drop old unique constraint on plugin_name if exists
ALTER TABLE mcp_plugins
DROP INDEX IF EXISTS plugin_name;
...
ALTER TABLE mcp_plugins
MODIFY COLUMN category VARCHAR(50) NULL DEFAULT 'general';
